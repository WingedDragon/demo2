...
public class FileIOUtil implements Serializable{
	...
	public static void main(String[] args) throws Exception{
		...
		boolean append = true;
		String pagePath = "d:\\person_age2.txt";
		String psalaryPath = "d:\\person_age.txt";

		int dcount = 1000000;

		List<String> datas = new ArrayList<String>();
		for(int i=1; i< dcount; i++){
			String key = CommonUtil.getRandomName();
			int age = CommonUtil.getRandomNum(1);
			datas.add(key+","+age);
		}
		writeFileLines(pagePath, datas, append);
		
		Date end = new Date();

		System.out.println("BEGIN=" + CommonUtil.formatDate(begin,"yyyy-MM-dd HH:mm:ss") + ",END=" + CommonUtil.formatDate(end,"yyyy-MM-dd HH:mm:ss"));
