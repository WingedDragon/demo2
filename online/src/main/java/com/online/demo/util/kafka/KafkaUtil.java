...
import com.online.demo.util.zookeeper.ZKClientUtil;
...
public class KafkaUtil {
    ...
    public static final String KAFKA_PRODUCER_CONFIG = "kafka/kafka-producer.properties";
    public static final String KAFKA_CONSUMER_CONFIG = "kafka/kafka-consumer.properties";
...
//     */
    ...
    public static void main(String[] args){
        ...
        String zkServers = "node61:2181,node62:2181,node63:2181/kafka";
        int zkSessionTimeout = 5000;
        int zkConnTimeout = 5000;

        //String topic = BeeConstant.TOPIC_BIKE;
        //String topic = BeeConstant.TOPIC_BATTERY;
        //String topic = BeeConstant.TOPIC_BATTERY_TEST;
        String topic = ReleaseConstant.TOPIC_TEST;
        ...
        topicList.add(ReleaseConstant.TOPIC_TEST);
        ...
        //kafkaUtil.createTopic(BeeConstant.TOPIC_TEST, partitions, replication);
