...
public class PropertyUtil implements Serializable{
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(getProperty("properties/db.properties", "zookeeper.quorum"));

        String path = "D:\\sparkWorkSpace\\dms\\src\\main\\resources\\properties";
        //        Map<String,Properties> proMap = loadAllProperties(path);
        //        for(Iterator<Map.Entry<String,Properties>> ite = proMap.entrySet().iterator(); ite.hasNext();){
        //            Map.Entry<String,Properties> entry = ite.next();
        //            String key = entry.getKey();
        //            System.out.println("------------"+key+"-----------------");
        //            Properties value = entry.getValue();
        //            for(Iterator<Map.Entry<Object,Object>> it = value.entrySet().iterator(); it.hasNext();){
        //                Map.Entry<Object,Object> en = it.next();
        //
        //                System.out.println("property " + en.getKey().toString() + "," + en.getValue().toString());
        //            }
        //        }

        System.out.println(PropertyUtil.readProperties2Map("es/es-setting.properties"));

        //System.out.println(PropertyUtil.readProperties2Map("redis/redis.properties"));
